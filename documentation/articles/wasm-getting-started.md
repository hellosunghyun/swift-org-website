...
Swift 6.2 및 개발 스냅샷부터 [swift.org](https://swift.org/download)에서 배포되는 Wasm용 Swift SDK로 Wasm 모듈을 쉽게 크로스 컴파일하고 실행할 수 있습니다.
...
1. 빌드할 플랫폼에 맞는 [설치 안내에 따라 `swiftly`를 설치](https://www.swift.org/install/)합니다.
