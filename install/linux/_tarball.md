...
- `Swift Automatic Signing Key #3 <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/{{ automatic_signing_key_file_3 }}>
  ...
  ```shell
  $ wget -q -O - /keys/{{ automatic_signing_key_file_3 }} | \
    gpg --import -
  ```
...
- `Swift Automatic Signing Key #2 <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/{{ automatic_signing_key_file_2 }}>
  ...
  ```shell
  $ wget -q -O - /keys/{{ automatic_signing_key_file_2 }} | \
    gpg --import -
  ```
...
- `Swift Automatic Signing Key #1 <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/{{ automatic_signing_key_file_1 }}>
  ...
  ```shell
  $ wget -q -O - /keys/{{ automatic_signing_key_file_1 }} | \
    gpg --import -
  ```
...
- `Swift 2.2 Release Signing Key <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/release-key-swift-2.2.asc>
  ...
  ```shell
  $ wget -q -O - /keys/release-key-swift-2.2.asc | \
    gpg --import -
  ```
...
- `Swift 3.x Release Signing Key <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/release-key-swift-3.x.asc>
  ...
  ```shell
  $ wget -q -O - /keys/release-key-swift-3.x.asc | \
    gpg --import -
  ```
...
- `Swift 4.x Release Signing Key <swift-infrastructure@swift.org>`
  ...
  다운로드
  : </keys/release-key-swift-4.x.asc>
  ...
  ```shell
  $ wget -q -O - /keys/release-key-swift-4.x.asc | \
    gpg --import -
  ```
